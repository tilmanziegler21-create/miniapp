import { buildBrandAssetUrl } from './branding';
...
const favoritesImg = buildBrandAssetUrl("tiles/tile-favorites.jpg");
const ordersImg = buildBrandAssetUrl("tiles/tile-orders.jpg");
const referralImg = buildBrandAssetUrl("tiles/tile-referral.jpg");
...
export const adminTiles: MenuTile[] = [
  {
    ...
    cta: "открыть",
    route: "/admin",
    image: buildBrandAssetUrl("tiles/tile-admin.jpg"),
    focal: "center",
...
export const courierTiles: MenuTile[] = [
  {
    ...
    cta: "открыть",
    route: "/courier",
    image: buildBrandAssetUrl("tiles/tile-courier.jpg"),
    focal: "center",
