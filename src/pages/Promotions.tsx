...
const Promotions: React.FC = () => {
  ...
  const styles = {
    ...
    contestCard: {
      background: 'linear-gradient(135deg, rgba(125,211,252,0.15) 0%, rgba(37,99,235,0.10) 100%)',
    ...
    wheelButton: {
      background: 'linear-gradient(135deg, rgba(96,165,250,0.20) 0%, rgba(37,99,235,0.15) 100%)',
      ...
      <div style={{ padding: `0 ${theme.padding.screen}` }}>
        ...
        {contests.filter(c => c.isActive).map((contest) => (
          <div key={contest.id} style={styles.contestCard}>
            <div style={styles.iconWrapper}>
              <TrendingUp size={24} color={theme.colors.dark.primary} />
            </div>
